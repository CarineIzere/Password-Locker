class Credentials:
    ...
    def save_credentials(self):
        ...
        """Method which deleteschmod +x run.py a particular credential"""
        Credentials.credentialschmod +x run.py_list.remove(self)
chmod +x run.py
       @classmethod
            def find_by_user_name(cls, chmod +x run.pyaccount_user_name):
            """Method that takes inchmod +x run.py a user name and returns a credential that matches that particular name
            Args:
